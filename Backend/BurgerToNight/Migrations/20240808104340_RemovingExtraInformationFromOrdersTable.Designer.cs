...
namespace BurgerToNightAPI.Migrations
{
    ...
    [Migration("20240808104340_RemovingExtraInformationFromOrdersTable")]
    partial class RemovingExtraInformationFromOrdersTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BurgerToNightAPI.Models.BurgerCategory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreationCategoryTime = new DateTime(2024, 8, 8, 15, 43, 38, 923, DateTimeKind.Local).AddTicks(883),
                        ...
                        {
                            Id = 2,
                            CreationCategoryTime = new DateTime(2024, 8, 8, 15, 43, 38, 923, DateTimeKind.Local).AddTicks(909),
                        ...
                        {
                            Id = 3,
                            CreationCategoryTime = new DateTime(2024, 8, 8, 15, 43, 38, 923, DateTimeKind.Local).AddTicks(912),
                        ...
                        {
                            Id = 4,
                            CreationCategoryTime = new DateTime(2024, 8, 8, 15, 43, 38, 923, DateTimeKind.Local).AddTicks(914),
                        ...
                        {
                            Id = 5,
                            CreationCategoryTime = new DateTime(2024, 8, 8, 15, 43, 38, 923, DateTimeKind.Local).AddTicks(916),
                        ...
                        {
                            Id = 6,
                            CreationCategoryTime = new DateTime(2024, 8, 8, 15, 43, 38, 923, DateTimeKind.Local).AddTicks(918),
            ...
            modelBuilder.Entity("BurgerToNightAPI.Models.BurgerProduct", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            BCategoryId = 3,
                            CreationDate = new DateTime(2024, 8, 8, 10, 43, 38, 923, DateTimeKind.Utc).AddTicks(1265),
                        ...
                        new
                        {
                            Id = 2,
                            BCategoryId = 2,
                            CreationDate = new DateTime(2024, 8, 8, 10, 43, 38, 923, DateTimeKind.Utc).AddTicks(1271),
                        ...
                        new
                        {
                            Id = 3,
                            BCategoryId = 4,
                            CreationDate = new DateTime(2024, 8, 8, 10, 43, 38, 923, DateTimeKind.Utc).AddTicks(1273),
                        ...
                        new
                        {
                            Id = 4,
                            BCategoryId = 1,
                            CreationDate = new DateTime(2024, 8, 8, 10, 43, 38, 923, DateTimeKind.Utc).AddTicks(1276),
                        ...
                        new
                        {
                            Id = 5,
                            BCategoryId = 5,
                            CreationDate = new DateTime(2024, 8, 8, 10, 43, 38, 923, DateTimeKind.Utc).AddTicks(1279),
                        ...
                        new
                        {
                            Id = 6,
                            BCategoryId = 6,
                            CreationDate = new DateTime(2024, 8, 8, 10, 43, 38, 923, DateTimeKind.Utc).AddTicks(1282),
            ...
            modelBuilder.Entity("BurgerToNightAPI.Models.OrderDetail", b =>
                {
                    ...
                    b.HasOne("BurgerToNightAPI.Models.BurgerProduct", "burgerProduct")
                        .WithMany()
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
