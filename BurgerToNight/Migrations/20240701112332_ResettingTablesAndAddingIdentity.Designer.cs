...
namespace BurgerToNightAPI.Migrations
{
    ...
    [Migration("20240701112332_ResettingTablesAndAddingIdentity")]
    partial class ResettingTablesAndAddingIdentity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BurgerToNightAPI.Models.BurgerCategory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreationCategoryTime = new DateTime(2024, 7, 1, 16, 23, 31, 36, DateTimeKind.Local).AddTicks(2561),
                        ...
                        {
                            Id = 2,
                            CreationCategoryTime = new DateTime(2024, 7, 1, 16, 23, 31, 36, DateTimeKind.Local).AddTicks(2581),
                        ...
                        {
                            Id = 3,
                            CreationCategoryTime = new DateTime(2024, 7, 1, 16, 23, 31, 36, DateTimeKind.Local).AddTicks(2584),
                        ...
                        {
                            Id = 4,
                            CreationCategoryTime = new DateTime(2024, 7, 1, 16, 23, 31, 36, DateTimeKind.Local).AddTicks(2587),
            ...
            modelBuilder.Entity("BurgerToNightAPI.Models.BurgerProduct", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            BCategoryId = 3,
                            CreationDate = new DateTime(2024, 7, 1, 11, 23, 31, 45, DateTimeKind.Utc).AddTicks(8115),
                            Description = "",
                            Image = "",
                            Name = "Mighty Zinger",
                            PreparingTime = 10,
                        ...
                        new
                        {
                            Id = 2,
                            BCategoryId = 2,
                            CreationDate = new DateTime(2024, 7, 1, 11, 23, 31, 45, DateTimeKind.Utc).AddTicks(8124),
                            Description = "",
                            Image = "",
                            Name = "Big Ben",
                            PreparingTime = 10,
                        ...
                        new
                        {
                            Id = 3,
                            BCategoryId = 4,
                            CreationDate = new DateTime(2024, 7, 1, 11, 23, 31, 45, DateTimeKind.Utc).AddTicks(8128),
                            Description = "",
                            Image = "",
                            Name = "Big Bang",
                            PreparingTime = 10,
                        ...
                        new
                        {
                            Id = 4,
                            BCategoryId = 1,
                            CreationDate = new DateTime(2024, 7, 1, 11, 23, 31, 45, DateTimeKind.Utc).AddTicks(8132),
                            Description = "",
                            Image = "",
                            Name = "Super BBQ",
                            PreparingTime = 10,
