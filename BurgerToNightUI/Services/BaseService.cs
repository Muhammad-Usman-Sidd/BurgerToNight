...
namespace BurgerToNightUI.Services
{
    public class BaseService : IBaseService
    {
        ...
        public async Task<T> SendAsync<T>(APIRequest apiRequest)
        {
            try
            {
                var client = httpClient.CreateClient("BurgerAPI");
                ...
                try
                {
                    ...
                    if (Data != null && (apiResponse.StatusCode == System.Net.HttpStatusCode.BadRequest
                        || apiResponse.StatusCode == System.Net.HttpStatusCode.NotFound))
                    {
                        Data.StatusCode = System.Net.HttpStatusCode.BadRequest;
