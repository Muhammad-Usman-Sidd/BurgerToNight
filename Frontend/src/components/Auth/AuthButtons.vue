    ...
    >
      <div class="flex flex-col space-y-1 p-2">
        <RouterLink v-if="!isLoggedIn" to="/login">
          <button
            class="w-full justify-center px-4 py-2 bg-orange-500 text-white rounded hover:bg-orange-700"
          >
            Sign In
          </button>
        </RouterLink>
        <RouterLink v-if="!isLoggedIn" to="/register">
          <button
            class="w-full justify-center px-4 py-2 bg-green-500 text-white rounded hover:bg-green-700"
          >
            Sign Up
          </button>
        </RouterLink>
        <RouterLink v-if="isLoggedIn" to="/reset-password">
          <button
            class="w-full justify-center px-4 py-2 bg-yellow-500 text-white rounded hover:bg-yellow-700"
          >
            Reset Password
          </button>
        </RouterLink>
